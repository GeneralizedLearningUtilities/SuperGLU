...
public class MockSerializables {
    public static class MockSerializable extends SuperGlu_Serializable {
        private int foo;
        private String bar;
    ...
    public static class MockSerializable2 extends SuperGlu_Serializable {
        private int foo;
        private String bar;
    ...
    public static class MockSerializable3 extends SuperGlu_Serializable {
        private int foo;
        private String bar;
    ...
    public static class MockSerializable4 extends SuperGlu_Serializable {
        private int foo;
        private String bar;
        ...
        public void initializeFromToken(StorageToken token) {
            ...
            this.foo = (int) token.getItem(FOO_KEY, true, -1);
            this.bar = (String) token.getItem(BAR_KEY, true, null);
            this.baz = (MockSerializable) SuperGlu_Serializable.createFromToken((StorageToken) token.getItem(BAZ_KEY, true, null));
        }
