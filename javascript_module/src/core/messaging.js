...
var ACCEPT_PROPOSAL_ACT, AGREE_ACT, CANCEL_ACT, CALL_FOR_PROPOSAL_ACT,
    ...
    CONFIRM_PROPOSAl_ACT, PROPOSED_MESSAGE_ACT, PROPOSED_MESSAGE_ACK_ACT , REJECT_PROPOSAL_ACT,
...
PROPOSE_ACT = "Propose";
CONFIRM_PROPOSAl_ACT = "Confirm Proposal";   ///NEW
PROPOSED_MESSAGE_ACT = "Proposed Message";  ///NEW
PROPOSED_MESSAGE_ACK_ACT = "Proposed Message Acknowledgement" //NEW
...
SPEECH_ACT_SET = {
    ...
    SUBSCRIBE_ACT: true, CONFIRM_PROPOSAl_ACT: true, PROPOSED_MESSAGE_ACT: true, 
    PROPOSED_MESSAGE_ACK_ACT: true , REJECT_PROPOSAL_ACT: true
};
...
namespace.CONFIRM_PROPOSAl_ACT = CONFIRM_PROPOSAl_ACT;
namespace.PROPOSED_MESSAGE_ACT = PROPOSED_MESSAGE_ACT;
namespace.PROPOSED_MESSAGE_ACK_ACT = PROPOSED_MESSAGE_ACK_ACT;
namespace.REJECT_PROPOSAL_ACT = REJECT_PROPOSAL_ACT;
